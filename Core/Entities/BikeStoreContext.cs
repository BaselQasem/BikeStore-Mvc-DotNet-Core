...
namespace BikeStoreDB.Models
{
    public partial class BikeStoreContext : DbContext
    {
        ...
        public BikeStoreContext(DbContextOptions<BikeStoreContext> options, IConfiguration config)
            : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Staff>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164EB7CF166")
                    .IsUnique();
